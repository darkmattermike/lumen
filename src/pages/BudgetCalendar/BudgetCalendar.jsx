    ...
    <SwShell>
      ...
      <div className={s.legend} style={{gridTemplateColumns:'repeat(5,1fr)'}}>
        {[
          ...
          {color:C.sv,  label:'Savings (total)',          detail:'Personal $929 · Stearns ·1244 $5,100 · ·3046 $440 · ·4182 $900 · Liberty $5,900', bal:'$13,269 liquid · 401k $42,000', balOk:true},
        ].map((a,i) => (
          <div key={i} className={s.legendItem} style={{'--ac':a.color}}>
            <div className={s.ldot}/>
            <div className={s.linfo}><div className={s.lname}>{a.label}</div><div className={s.ldetail}>{a.detail}</div></div>
