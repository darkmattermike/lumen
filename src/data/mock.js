...
let _accounts = [
  { id: 1, name: 'Everyday Checking',  type: 'depository', balance: 4318.77,  mask: '4821', institution: 'Chase',       icon: '🏦', is_debt: false, include_in_balance: true,  forecast_role: 'source',    interest_rate: 0,    limit_amt: 0,    minimum_payment: 0 },
  { id: 2, name: 'High-Yield Savings', type: 'depository', balance: 12850.00, mask: '9930', institution: 'Ally',        icon: '🐷', is_debt: false, include_in_balance: true,  forecast_role: 'protected', interest_rate: 4.2,  limit_amt: 0,    minimum_payment: 0 },
